...
librarian::shelf(
  digest, dplyr, DT, glue, keras, purrr, readr, stringr, tidyr)
...
```{r}
dir_models_2 <- file.path(base_dir, "dir_models_2")
dir.create(dir_models_2, recursive=T, showWarnings = F)
mdl1_h5 <- file.path(dir_models_2, "sp2.h5")
mdl1_history_rds <- file.path(dir_models_2, "sp2_history.rds")
```
